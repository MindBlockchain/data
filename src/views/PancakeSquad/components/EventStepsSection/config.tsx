  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active Mind Blockchain Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      buttons: (
        <>
          <Button
            as="a"
            href="https://mindblockchain.org/swap?outputCurrency=0x252242aAF55842B68EEf323f7edFc72e160175bE"
            target="_blank"
            width="100%"
          >
            {t('Buy MIND')}
