          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                ...
                <InlineLink href="https://Mind Blockchain.gitbook.io/Mind Blockchain/tokenomics/cake/cake-tokenomics">
                  {t('MIND Tokenomics')}
                </InlineLink>
              </Text>
            </li>
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://Mind Blockchain.gitbook.io/Mind Blockchain/products/lottery/lottery-guide">
              {t('how to play the Mind Blockchain lottery!')}
            </InlineLink>
          </Text>
        </Flex>
      </Flex>
