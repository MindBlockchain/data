    ...
    <>
      ...
      <Wrapper>
        <Heading mb="24px" scale="xl" color="white">
          {t('Security is a top priority at Mind Blockchain')}
        </Heading>
        <Text textAlign="center" color="white">
          {t('Security Audit is coming soon. Once we finish the latest development works we will start multiple audits by respected agents.')}
        </Text>
