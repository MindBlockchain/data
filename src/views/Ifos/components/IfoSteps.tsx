    ...
    switch (step) {
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active Mind Blockchain Profile to take part in an IFO!')}
            </Text>
            {renderAccountStatus()}
          </CardBody>
        )
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Get %symbol%', { symbol: 'MIND' })}
            </Heading>
            <Text color="textSubtle" small>
              {t('You’ll spend MIND to buy IFO sale tokens.')}
            </Text>
            <Button
              as={Link}
              external
              href="/swap?outputCurrency=0x252242aAF55842B68EEf323f7edFc72e160175bE"
      ...
      case 2:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t('When the IFO sales are live, you can “commit” your MIND to buy the tokens being sold.')} <br />
